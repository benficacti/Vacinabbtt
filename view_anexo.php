            ...
            <div class="main-panel" style=" width: 100%">
                ...
                <script type="text/javascript">
                                            ...
                                            function listar_anexo() {
                                                var cod_view = document.getElementById('id_cod_ocorrencia_view').value;

                                                $.ajax({

                                                    url: '_api/api.php',
                                                    method: 'post',
                                                    data: {request: 'listar_anexo',
                                                        cod: cod_view
                                                    ...
                                                    success: function (data) {
                                                        ...
                                                        obj.forEach(function (name, value) {
                                                            document.getElementById('id_dados_funcionario').innerHTML = name.FUNCIONARIO + '/' +name.CHAPA;
                                                            document.getElementById('res_view_anexo').innerHTML = '<iframe src="uploads/' + name.IMG + '" style="width: 100%;height: 415px;border: none;"></iframe>';
