...
if ($request != null && $request == "search_painel") {


    echo $painel = Search::painel();
}

if ($request != null && $request == "search_funcionario") {
    $chapa = (null != (filter_input(INPUT_POST, 'chapa'))) ? filter_input(INPUT_POST, 'chapa') : null;

    echo $funcionario = Search::buscar_funcionario($chapa);
}

if ($request != null && $request == "listar_anexo") {
    $chapa = (null != (filter_input(INPUT_POST, 'cod'))) ? filter_input(INPUT_POST, 'cod') : null;

    echo $anexo = Search::buscar_anexo($chapa);
}
